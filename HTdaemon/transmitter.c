...
void		RecvBad _FA_((int, int, int, int, Ulong, Uchar *));
void		RecvEOMA _FA_((int, int, int, int, Ulong, Uchar *));
void		RecvLEOT _FA_((int, int, int, int, Ulong, Uchar *));
void		RecvLMQE _FA_((int, int, int, int, Ulong, Uchar *));
void		RecvNAK _FA_((int, int, int, int, Ulong, Uchar *));
void		RecvSOMA _FA_((int, int, int, int, Ulong, Uchar *));
...
/*ARGSUSED*/
void
RecvBad(dir, chan, type, size, addr, data)
	int		dir;
	int		chan;
	int		type;
	int		size;
...
void
RecvEOMA(dir, chan, type, size, addr, data)
	int		dir;
	int		chan;
	int		type;
	int		size;
...
/*ARGSUSED*/
void
RecvLEOT(dir, chan, type, size, addr, data)
	int		dir;
	int		chan;
	int		type;
	int		size;
...
/*ARGSUSED*/
void
RecvLMQE(dir, chan, type, size, addr, data)
	int		dir;
	int		chan;
	int		type;
	int		size;
...
void
RecvNAK(dir, chan, type, size, addr, data)
	int		dir;
	int		chan;
	int		type;
	int		size;
...
void
RecvSOMA(dir, chan, type, size, addr, data)
	int		dir;
	int		chan;
	int		type;
	int		size;
	...
	register Chan *	chnp;
{
	...
	S_SOMDATA(PktWriteData, waittime, chnp->ch_msgid);

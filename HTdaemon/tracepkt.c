...
/*	static char	header[] = "elapse <<>>    address type ch d   size [data...] comment\n";	*/
	static char	format[] = "%6lu %s%11lu%5s %d %d%7d [%.38s] %s\n";
#	define		MAXDATASTRLEN			        38

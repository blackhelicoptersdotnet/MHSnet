...
static char	sccsid[]	= "@(#)main.c	1.62 05/12/16";
...
long	OutDataSize	= MAXPKTDATASIZE;	/* Output data packet data size */
...
char	ReaderName[]	= english("VCreader");
...
char	WriterName[]	= english("VCwriter");
